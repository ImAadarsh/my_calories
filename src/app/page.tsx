    ...
    <div className="flex flex-col min-h-screen bg-[#f8fafc] dark:bg-slate-950 pb-[115px]">
      ...
      <header className="py-1.5 px-6 flex items-center justify-between sticky top-0 z-40 bg-white dark:bg-slate-950 border-b border-slate-100 dark:border-white/5 transition-all">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-slate-900 dark:text-cream font-black text-base font-display leading-tight">Hey, {session.user?.name?.split(' ')[0]}!</h2>
          </div>
        </div>
            ...
            >
              ...
              <div className="bg-slate-900 rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden">
                <div className="relative z-10">
                  <h4 className="font-black text-2xl font-display mb-8 flex items-center gap-3 text-cream">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-10 border border-slate-100 dark:border-white/5 shadow-xl space-y-10">
                <div className="flex flex-col items-center gap-4 border-b border-slate-50 dark:border-white/5 pb-8">
                  <div className="relative">
                    <img src={session.user?.image || ""} className="w-24 h-24 rounded-[2.5rem] border-4 border-[#f8fafc] dark:border-slate-800 shadow-2xl" alt="Profile" />
                  ...
                  <div className="text-center">
                    <h2 className="text-2xl font-black text-slate-900 dark:text-cream font-display">{session.user?.name}</h2>
                    <p className="text-sm font-bold text-slate-400 dark:text-cream/40">{session.user?.email}</p>
                  </div>
                </div>
                  ...
                  <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <div className="p-6 bg-blue-50 dark:bg-gold/10 rounded-[2rem] border-2 border-blue-600/10 dark:border-gold/10">
                      <div className="flex items-center gap-2 mb-2">
                        <Info size={16} className="text-blue-600 dark:text-gold" />
                  ...
                  <>
                    <div className="flex justify-between items-start">
                      ...
                      <div className="px-5 py-3 bg-blue-50 dark:bg-gold/10 rounded-2xl">
                        <p className="text-xl font-black text-blue-600 dark:text-gold">{selectedMeal.calories}<span className="text-[10px] ml-1">kcal</span></p>
                      </div>
                    </div>
